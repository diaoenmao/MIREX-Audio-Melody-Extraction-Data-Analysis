Boxplot_overall <- function() {
  ...
  out<-out*100
  boxplot(out$MIREX2009_0db, out$ADC04, out$MIREX2005, out$MIREX2008, out$MIREX2009_m5db, out$MIREX2009_p5db, main="Overall accuracy across all datasets from 2009 to 2014", 
